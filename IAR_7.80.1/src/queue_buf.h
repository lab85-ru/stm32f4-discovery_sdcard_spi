...
typedef struct queue_buf_type
{
    ...
    QUEUE_DATA_TYPE *w_buf;                             // promrhutochniy buffer dla copurivaniya danih w_buf -> queue
    QUEUE_VAR_TYPE w_len;                               // dlinna dannih v w_buf

	QUEUE_DATA_TYPE *r_buf;                             // promrhutochniy buffer dla copurivaniya danih r_buf <- queue
    QUEUE_VAR_TYPE r_len;                               // dlinna dannih v r_buf
} queue_buf_t;
